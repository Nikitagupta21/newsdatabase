...
<html>
        ...
        <%
            ...
            for(Person person : rows)
              ...
              <tr>
                  ...
                  <td><a href="edit.jsp?id=<%=person.getId()%>" class="btn btn-success"> <i class="fa fa-pencil" aria-hidden="true"></i></a>  |  <a href="PersonControllers?id=<%=person.getId()%>&op=delete" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a> </td>
              </tr>
            <%}%>  
    ...
    <br/><br/>
    <a href='register.jsp' class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i>Add More Record</a>
    </body>
</html>